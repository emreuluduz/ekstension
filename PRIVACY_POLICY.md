...
- **Local Storage:** All user preferences (such as selected theme, blocked keyword filters, blocked author lists, and favorite topics) are stored strictly locally on your device via Chrome's `chrome.storage.local` API. This data never leaves your browser.
...
| Permission | Purpose |
| :--- | :--- |
| `storage` | To store user preferences (theme, blocked keyword filters, blocked authors, favorite topics) locally on your device. |
